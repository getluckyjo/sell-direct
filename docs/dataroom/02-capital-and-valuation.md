...
A **profitable, capital-efficient, high-margin** business that reaches breakeven on ~R11m is a
strong story for disciplined investors. We set seed pre-money at **~R50–60m**, justified by the
live product, the deployed dashboard, the defensible monetisation wedge, the **~50% mature
margin**, and a **clear path to profit on a single small round.**

### Suggested cap-table framing (illustrative)

| Round | Pre-money | Raise | Post-money | New-investor stake |
|---|---:|---:|---:|---:|
| Seed | R50m | R15m | R65m | ~23% |
| Series A (optional, growth) | ~R350m | R60m | R410m | ~15% |
