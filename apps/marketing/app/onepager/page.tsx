...
const CHAPTERS = [
  ...
  },
  {
    ...
    points: [
      ...
      'In-chat bond pre-qualification via BetterBond (our originator)',
  ...
  },
  {
    ...
    who: 'Conveyancing',
    points: [
      'Multi-bank bond application via BetterBond → bond granted',
...
const COMPLIANCE = [
  ...
  'Registered property practitioners (PPRA, Fidelity Fund Certificate) assist both parties throughout — registration is a precondition to taking any mandate',
