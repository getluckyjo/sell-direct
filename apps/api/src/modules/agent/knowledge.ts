...
- Coverage: the greater Cape Town area, roughly a 150 km radius. We are expanding soon but deliberately keep focus on service delivery — for a home outside that area, say so honestly, invite them to leave their details, and escalate so the team logs the interest for expansion.
