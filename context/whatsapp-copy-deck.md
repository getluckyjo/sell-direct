...
> **ARCHIVED — historical record, not live copy.**
> Preserved from the unmerged `claude/whatsapp-copy-deck` branch (10 July 2026).
> Editing this file changes nothing. The messages that actually ship live in
...
> guidance all post-date this deck. See `context/archive.md`.
